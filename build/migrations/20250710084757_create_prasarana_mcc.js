...
async function up(knex) {
    await knex.schema.createTable('prasarana_mcc', (table) => {
        ...
        table.string('lantai', 20).notNullable();
        table.boolean('is_bookable').defaultTo(true);
...
//# sourceMappingURL=20250710084757_create_prasarana_mcc.js.map